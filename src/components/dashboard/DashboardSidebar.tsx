...
import {
  LayoutDashboard, Send, Users, Megaphone, FileText, BarChart3, Key,
  CreditCard, Settings, MessageSquare, Tag, LogOut,
} from "lucide-react";
    ...
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col bg-sidebar border-r border-sidebar-border">
      ...
      {user && (
        <div className="border-b border-sidebar-border px-6 py-3">
          ...
          <p className="text-xs text-sidebar-foreground/50 truncate">{user.sms_balance?.toLocaleString() || 0} credits</p>
        </div>
      )}
